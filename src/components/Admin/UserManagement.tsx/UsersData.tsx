                    ...
                    <td className="pl-4 py-4 ">
                        {props.role === 'resident' ?
                            <button
                                ...
                                className="pr-2 md:px-6 py-2 md:bg-accent text-white rounded-md md:rounded-3xl cursor-pointer hover:bg-primary md:hover:bg-accent/90">
                                <span className='hidden md:inline'>View Detail</span>
                                <Eye className='md:hidden inline text-accent2'/>
                            </button> :
                            <button 
                            onClick={() => handleCollectorDetails(user.firstName, user.lastName, user._id)}
                            className="pr-2 md:px-6 py-2 bg-accent text-white rounded-3xl cursor-pointer hover:bg-accent/90">
                                <span className='hidden md:inline'>View Detail</span>
                                <Eye className='md:hidden inline text-accent2'/>
                            </button>
                        }
